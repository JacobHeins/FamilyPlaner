...
- N/A (frontend-only; backend persists to PostgreSQL via Spring Boot) (002-weekly-activity-planner)
- TypeScript 5.7 for SPA delivery; Java 21 backend contract as integration context + React 19, React Router 7, RTK Query 2.6, lucide-react (002-weekly-activity-planner)
- Existing backend persistence only; no new frontend storage (002-weekly-activity-planner)
